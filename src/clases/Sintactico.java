...
Programa: 5.2 Analizador Sintáctico y Semántico Básico
            ...
            switch (state) {                
                ...
                case "inicia":                            
                    if(String.valueOf(temp2)=="fin_bloque"){                            
                            ...
                            LGUI.t4.append("\r\nError al declarar bloque, Linea: "+Line);
                            LGUI.t4.append("\r\n");  
                            flag=false;
                            temp=null;                   
                        }                        
                ...
                case "entero":    
                            ...
                            if(String.valueOf(temp)=="Identificador"){
                                ...
                                if(String.valueOf(temp)=="Punto y coma"){
                                    ...
                                    LGUI.t4.append("\r\nError al declarar Sentencia. Linea: " + Line);
                                    LGUI.t4.append("\r\n");  
                                    temp=null;
                                    flag=false;
                ...
                case "cad": //Producción para tipo de dato Cadena
                            ...
                            if(String.valueOf(temp)=="Identificador"){
                                ...
                                if(String.valueOf(temp)=="Punto y coma"){
                                    ...
                                    LGUI.t4.append("\r\nSe esperaban cosquillas. Linea: " + Line);
                                    LGUI.t4.append("\r\n");                                     
                                    temp=null;   
                                    flag=false;
                                }
                          ...
                          if(String.valueOf(temp)=="Paren abre"){
                                ...
                                if(String.valueOf(temp)=="Identificador"){
                                    if(symbolTableValor.containsKey(token.getName())){
                                        ...
                                        LGUI.t4.append("\r\nError, No esta declarada la variable. Linea: " + Line);
                                        LGUI.t4.append("\r\n");
                                        temp=null;                           
                                        flag=false;
                                        break;                                        
                                    ...
                                    if(String.valueOf(temp) == "Igualdad" || String.valueOf(temp) == "Mayor que" || String.valueOf(temp) == "Menor que" || String.valueOf(temp) == "Menor igual que" || String.valueOf(temp) == "Mayor igual que" || String.valueOf(temp) == "OR" || String.valueOf(temp) == "AND" || String.valueOf(temp) == "Negación" || String.valueOf(temp) == "Desigual"){
                                        ...
                                        if(String.valueOf(temp) == "Identificador"){
                                            if(symbolTableValor.containsKey(token.getName())){
                                                ...
                                                if(getValueFromKeyType2==getValueFromKeyType1){
                                                    ...
                                                    LGUI.t4.append("\r\nError, Tipos de dato incompatibles. Linea: " + Line);
                                                    LGUI.t4.append("\r\n");
                                                    temp=null;                           
                                                    flag=false;
                                                    break;                                                    
                                                ...
                                                LGUI.t4.append("\r\nError, Falta declarar variable. Linea: " + Line);
                                                LGUI.t4.append("\r\n");
                                                temp=null;                           
                                                flag=false;
                                                break;                                              
                                        ...
                                        LGUI.t4.append("\r\nError simbolo de comparacion. Linea: " + Line);
                                        LGUI.t4.append("\r\n");                                        
                                        temp=null;
                                        flag=false;
                                        break;
                ...
                case "imprime": //Producción para sentencia Imprime                         
                            ...
                            if(String.valueOf(temp) == "COMILLAS DOBLES"){//<<"
                                ...
                                if(symbolTableValor.containsKey(token.getName())){
                                    ...
                                    //\r\nError semantico en Bool
                                    LGUI.t4.append("\r\nError, la variable no esta declarada. Linea: " + Line);
                                    LGUI.t4.append("\r\n");                                    
                                    temp=null;
                                    flag = false;
                                    break;
                                ...
                                LGUI.t4.append("\r\nSe esperaba ' un valor '. Linea: " + Line);
                                LGUI.t4.append("\r\n");
                                temp=null;
                            }
                        break;
                                ...
                                if(String.valueOf(temp)=="Identificador" || String.valueOf(temp)=="Valores numéricos"){
                                    ...
                                    if(String.valueOf(temp) == "Igualdad" || String.valueOf(temp) == "Mayor que" || String.valueOf(temp) == "Menor que" || String.valueOf(temp) == "Menor igual que" || String.valueOf(temp) == "Mayor igual que" || String.valueOf(temp) == "OR" || String.valueOf(temp) == "AND" || String.valueOf(temp) == "Negación" || String.valueOf(temp) == "Desigual"){
                                        ...
                                        if(String.valueOf(temp) == "Identificador" || String.valueOf(temp)=="Valores numéricos"){
                                            ...
                                            LGUI.t4.append("\r\nError en condición, símbolo erroneo. Linea: " + Line);
                                            LGUI.t4.append("\r\n");
                                            temp=null;
                                        }
                                    }else{
                ...
                case "identificador": //Producción para asignación
                            ...
                            if(auxTemp==auxName){                                
                                ...
                                //\r\nError semantico en Bool
                                LGUI.t4.append("\r\nVariable no declarada, Linea: "+ Line);
                                LGUI.t4.append("\r\n");                                    
                                temp=null;
                                flag = false;
                                break;
                            ...
                            if(String.valueOf(temp) == "Asignación"){
                                ...
                                if(String.valueOf(temp) == "Identificador"){
                                    ...
                                    if(String.valueOf(temp) == "Punto y coma"){
                                        ...
                                        LGUI.t4.append("\r\nSe esperaba un ' operador '. Linea: " + Line);
                                        LGUI.t4.append("\r\n");
                                        temp=null;
                                        flag=false;
                                        break;
                                ...
                                LGUI.t4.append("\r\nSe esperaba 'Identificador, Número o Comillas'. Linea: " + Line);
                                LGUI.t4.append("\r\n");                           
                                temp=null;
                                flag = false;                                    
                                }
