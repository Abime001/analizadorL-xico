    ...
    public void Analizar() {
        ...
        while (!list1.isEmpty()) {            
            ...
            switch (state) {
                ...
                case 23: // /
                    token.setName(GetList2());
                    token.setType("Operador división");
                    token.setValor(666);
                    token.setLine(line);
                    LGUI.t2.append(token.toString());
                    LGUI.t2.append("\r\n");
                ...
                case 93:
                        ...
                        token.setType("ENTONCES"); //Palabras clave de la sentencia
                        token.setValor(90);
                        token.setLine(line);
                        LGUI.t2.append(token.toString());
                        LGUI.t2.append("\r\n");
                ...
                case 97:
                        String c7 = GetList2();
                        token.setName(c7.trim());
                        token.setType("SINO"); //Palabras clave de la sentencia
                        token.setValor(90);
                        token.setLine(line);
                        LGUI.t2.append(token.toString());
                        LGUI.t2.append("\r\n");
